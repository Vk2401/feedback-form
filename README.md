...
FeedBack form it is used for get a peoples thought about you

if you need to send email read about [EmailJS](https://www.emailjs.com/) which i used in this project

## Demo🚀

<a target="_blank" href="https://vk2401.github.io/feedback-form/">Live Link</a>
...
1. Clone the repository to your local machine:
   ...
   ```bash
   git clone https://vk2401.github.io/feedback-form/
